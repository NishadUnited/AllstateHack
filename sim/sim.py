...
for x in xrange (1, 10080):
	...
	data = json.dumps({"homeWaterSensorAlarmOff" :{"doorSensor":{"value":str(door)},"garageSensor":{"value":str(garage)},"IRSensor":{"value":str(heat)},"audioSensor":{"value":str(audio)},"timestamp":str(time)}})
